...
const PetsCategory = () => {
    ...
    return (
        <div className='p-20 bg-[#f1f6fa] pb-30'>
            ...
            <h3 className='text-center font-bold text-3xl mb-15 mt-5 text-black'>All your Pets for Adoption</h3>


            <div className='grid grid-cols-1 lg:grid-cols-4 gap-5'>
                {
                petData.map(i => <div key={i?._id} className="card bg-base-100 shadow-2xl p-3">
                    <figure>
