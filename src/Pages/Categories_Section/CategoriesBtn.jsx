        ...
        <div className='mt-20 ml-10 mr-10 pb-20'>
            ...
            <div className='mt-10 flex  justify-center items-center space-x-10'>
                ...
                <div onClick={handleAccessoriesCategories}>
                    <button className='btn bg-[#c2f8d7] p-20 rounded-2xl border-0'><img className='w-17 bg-transparent' src="/public/my_assets/Pet Accessories.png" alt="" /></button>
                    <p className='text-center mt-5 font-semibold text-gray-700'>Pet Accessories</p>
                </div>

                <div onClick={handleCareProdCategories}>
                    <button className='btn bg-[#F3E6FF] p-20 rounded-2xl border-0'><img className='w-17  bg-transparent' src="/public/my_assets/pills-bottle.png" alt="" /></button>
