...
const CategoriesBtn = () => {
    ...
    return (
        <div className='p-8 md:p-16 lg:pt-25'>
            <p className='text-center font-bold text-3xl text-black'>Shop By Categories</p>
            <div className='mt-5 flex flex-wrap justify-center items-center gap-10'>
