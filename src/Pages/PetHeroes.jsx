...
const PetHeroes = () => {
    ...
    return (
        ...
        <h2 className='text-5xl font-bold text-center mb-12 text-black'>Meet Our Pet Heroes</h2>

      <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5'>

        {petHeroes.map((i, index) => (
          <div key={index} className='bg-white shadow-2xl p-5 rounded-lg text-center'>
            <img className='w-15 h-15 mx-auto rounded-full mb-2' src={i.image} alt={i.name} />
