...
const RecentListings = () => {
    ...
    return (
        <div className='p-20'>
           <h3 className='text-center font-bold text-4xl mb-15  text-black'>Recently Listed Items</h3>


            <div className='grid grid-cols-1  lg:grid-cols-6 gap-2'>
                {
                recent.map(i => <motion.div initial={{ scale: 1.5 }} animate={{ scale: 1 , transition: { duration: 1 } }}> <div key={i?._id} className="card bg-base-100 shadow-md p-2">
                    <figure>
                        <img className=' object-cover w-full h-42 rounded-lg' src={i?.imageURL}  alt="Shoes" />
                    </figure>

                    <div className="card-body">
                        <h2 className="card-title text-center">{i?.name} </h2>
